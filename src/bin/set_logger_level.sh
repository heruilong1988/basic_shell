...
echo "xxx operation tool - set logger level"
...
/usr/bin/curl http://${SERVER_IP_PORT}/jolokia/exec/xxx:type=LoggerModification/setLoggerLevel/${PACKAGE_CLASS_PATH}/${LOGGER_LEVEL}
